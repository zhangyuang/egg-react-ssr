...
export async function component(option: Optional): Promise<boolean> {
        ...
        list.forEach(p => {
            ...
            if (p.indexOf('.css.nj') > -1) {
                ...
                /** ts 版本对应的是 *.module.scss */
                    ...
                    if (filepath_perfix.indexOf('assets') > -1) {
                        filepath = filepath_perfix + ".scss";
                    }
                    else {
                        filepath = filepath_perfix + ".module.scss";
                    }
                }
