...
import { renderRouter, getComponent } from 'ykfe-utils'
      ...
      <Layout>
        {
          ...
          Routes.map(({ path, exact, Component }, key) => <Route exact={exact} key={key} path={path} render={props => renderRouter(Component(), props)} />)
        }
      </Layout>
    </BrowserRouter>
